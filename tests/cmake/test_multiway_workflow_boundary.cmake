...
foreach(workflow train buckets inspect evaluate)
    string(FIND "${cmake_text}" "texas_multiway_${workflow}" target_position)
    if(target_position EQUAL -1)
        message(FATAL_ERROR "missing multiway ${workflow} research target")
    endif()
endforeach()
