...
void scalar_regret_matching<float>(
    ...
    texas::solver::hunl::regret_matching_action_major_f32_scalar(regret, actions, buckets, strategy);
}

template <>
void scalar_regret_matching<double>(
    const double* regret, std::uint32_t actions, std::uint32_t buckets, double* strategy) {
    texas::solver::hunl::regret_matching_action_major_f64_scalar(regret, actions, buckets, strategy);
}
...
void dispatched_regret_matching<float>(
    const float* regret, std::uint32_t actions, std::uint32_t buckets, float* strategy) {
    texas::solver::hunl::regret_matching_action_major_f32(regret, actions, buckets, strategy);
}

template <>
void dispatched_regret_matching<double>(
    const double* regret, std::uint32_t actions, std::uint32_t buckets, double* strategy) {
    texas::solver::hunl::regret_matching_action_major_f64(regret, actions, buckets, strategy);
}
...
TEST_CASE(hunl_p75_f32_dispatch_rejects_null_or_empty_rows_without_writing) {
    ...
    texas::solver::hunl::regret_matching_action_major_f32(nullptr, 2U, 1U, strategy.data());
    texas::solver::hunl::regret_matching_action_major_f32(regret.data(), 2U, 1U, nullptr);
    texas::solver::hunl::regret_matching_action_major_f32(regret.data(), 0U, 1U, strategy.data());
    texas::solver::hunl::regret_matching_action_major_f32(regret.data(), 2U, 0U, strategy.data());
...
TEST_CASE(hunl_p75_f64_dispatch_rejects_null_or_empty_rows_without_writing) {
    ...
    texas::solver::hunl::regret_matching_action_major_f64(nullptr, 2U, 1U, strategy.data());
    texas::solver::hunl::regret_matching_action_major_f64(regret.data(), 2U, 1U, nullptr);
    texas::solver::hunl::regret_matching_action_major_f64(regret.data(), 0U, 1U, strategy.data());
    texas::solver::hunl::regret_matching_action_major_f64(regret.data(), 2U, 0U, strategy.data());
